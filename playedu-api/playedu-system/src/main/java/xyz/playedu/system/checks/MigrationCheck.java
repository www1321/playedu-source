                            ...
                            new HashMap<>() {
                                {
                                    ...
                                    put(
                                            ...
                                            """
                                                    ...
                                                    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='LDAP部门同步详情表';
                                                    """);
                                }
                            });
                    add(
                                    ...
                                    put(
                                            ...
                                            """
                                                    CREATE TABLE `ldap_sync_user_detail` (
                                                      ...
                                                      KEY `record_id` (`record_id`),
                                                      KEY `user_id` (`user_id`)
                                                    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='LDAP用户同步详情表';
                                                    """);
                                }
                            });
                }
